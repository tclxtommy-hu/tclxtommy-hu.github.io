...
| [09-harness-engineering.md](AI辅助编程范式/09-harness-engineering.md) | Harness Engineering（外壳工程） | 把包裹 LLM 的运行外壳（工具/沙箱/编排）作为一等工程对象 |
| [10-graph-engineering.md](AI辅助编程范式/10-graph-engineering.md) | Graph Engineering（图工程） | 把多 Agent/多步骤显式建模为节点-边-状态图来编排 |
