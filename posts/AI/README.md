...
| [02-模型服务化.md](AI知识库/11-推理与部署/02-模型服务化.md) | 部署形态、服务化、成本与弹性 |
| [03-推理框架.md](AI知识库/11-推理与部署/03-推理框架.md) | 推理框架概念、与 LLM/Agent 分层、主流引擎选型 |
| [04-vLLM.md](AI知识库/11-推理与部署/04-vLLM.md) | vLLM：安装、场景与硬件、PagedAttention、Serving |
...
| [02-多智能体概念体系与学习要点.md](Agent开发知识/06-多智能体/02-多智能体概念体系与学习要点.md) | 概念全景、学习路线、设计自检 |
| [03-多智能体实战示例-LangGraph-Supervisor.md](Agent开发知识/06-多智能体/03-多智能体实战示例-LangGraph-Supervisor.md) | LangGraph Supervisor MVP 实战 |
| [04-跨Agent通信.md](Agent开发知识/06-多智能体/04-跨Agent通信.md) | 进程内/跨系统通信、契约、A2A 与 MCP 分工 |

### 07 RAG 与知识集成
| 文件 | 主题 |
|------|------|
| [01-RAG与知识集成.md](Agent开发知识/07-RAG与知识集成/01-RAG与知识集成.md) | 检索增强生成、知识库、与 Agent 结合 |
| [02-RAG 核心概念与原理…](Agent开发知识/07-RAG与知识集成/02-RAG%20核心概念与原理：Chunking、Embedding、相似度、HNSW%20与多路召回.md) | Chunking、Embedding、HNSW、多路召回与 Rerank |
| [03-主流 RAG 开源项目.md](Agent开发知识/07-RAG与知识集成/03-主流%20RAG%20开源项目.md) | 框架/向量库/GraphRAG 等开源选型 |
| [04-Graph-Recall.md](Agent开发知识/07-RAG与知识集成/04-Graph-Recall.md) | Graph Recall：实体图谱召回原理与实现 |
| [05-RAG权限管控.md](Agent开发知识/07-RAG与知识集成/05-RAG权限管控.md) | 文档 ACL × 用户属性、晋升即时生效、预过滤 |
...
| [02-PydanticAI详解.md](Agent开发知识/10-框架与工具/02-PydanticAI详解.md) | PydanticAI 详解，并与 LangChain / LangGraph 对比 |
...
| [02-Agent.md与Memory.md规范.md](Agent开发知识/12-补充概念/02-Agent.md与Memory.md规范.md) | Agent.md 配置文件与 Memory.md 持久化记忆的 Markdown 实践；附腾讯 TencentDB Agent Memory 工程化实例 |
| [03-关于Agent Skill Router的几点思考.md](Agent开发知识/12-补充概念/03-关于Agent%20Skill%20Router的几点思考.md) | Skill Router：意图匹配、编排与降级 |

### 13 进阶与工程化
| 文件 | 主题 |
|------|------|
| [00-知识体系全景与补遗地图.md](Agent开发知识/13-进阶与工程化/00-知识体系全景与补遗地图.md) | 01–12 覆盖评估与补项导航 |
| [01-Agent设计模式与工作流.md](Agent开发知识/13-进阶与工程化/01-Agent设计模式与工作流.md) | Workflow vs Agent、常见编排模式 |
| [02-上下文工程.md](Agent开发知识/13-进阶与工程化/02-上下文工程.md) | 上下文构造、压缩与管理；附 OpenViking 上下文数据库实例 |
| [03-高级提示工程.md](Agent开发知识/13-进阶与工程化/03-高级提示工程.md) | 系统提示、few-shot、约束生成 |
| [04-可观测性与LLMOps.md](Agent开发知识/13-进阶与工程化/04-可观测性与LLMOps.md) | 三支柱 Trace/Span/Metric；Skill 生命周期与 MCP 链路追踪 |
| [05-可靠性与成本工程.md](Agent开发知识/13-进阶与工程化/05-可靠性与成本工程.md) | 重试/降级/熔断；token 与模型路由 |
| [06-多智能体进阶.md](Agent开发知识/13-进阶与工程化/06-多智能体进阶.md) | 通信、共识与框架实战补强 |
| [07-RAG工程化与GraphRAG.md](Agent开发知识/13-进阶与工程化/07-RAG工程化与GraphRAG.md) | 切分、混合检索、GraphRAG、评测 |
| [08-评测框架与基准详解.md](Agent开发知识/13-进阶与工程化/08-评测框架与基准详解.md) | Ragas/DeepEval 与主流 Agent 基准 |
| [09-安全实战OWASP与防护.md](Agent开发知识/13-进阶与工程化/09-安全实战OWASP与防护.md) | OWASP LLM Top 10 与防护落地 |
| [10-Agent协议与形态前沿.md](Agent开发知识/13-进阶与工程化/10-Agent协议与形态前沿.md) | A2A、Computer Use、语音 Agent 等 |
