...
本知识库按主题分为 16 个模块，从数学基础到前沿趋势，并附一篇横向"OSI 分层"归类总览，循序渐进。
...
| [02-模型服务化.md](11-推理与部署/02-模型服务化.md) | 部署形态、服务化、成本与弹性 |
| [03-推理框架.md](11-推理与部署/03-推理框架.md) | 推理框架概念、与 LLM/Agent 分层、主流引擎选型 |
| [04-vLLM.md](11-推理与部署/04-vLLM.md) | vLLM：安装、场景与硬件、PagedAttention、Serving |
...
| 文件 | 主题 |
|------|------|
| [01-AI技术体系与OSI七层映射.md](16-AI技术体系与OSI七层映射/01-AI技术体系与OSI七层映射.md) | 用 OSI 七层模型给 LLM/Agent/RAG/MCP 等做分层归位的心智模型 |
